...
func (m *Authors) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (m *Queries) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
var fileDescriptor_c0b0a0fd44626f41 = []byte{
	...
	,
}
