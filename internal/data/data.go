...
var TestData = [...]amodels.Article{
	...
	десятки успешных пилотных и коммерческих проектов, что позволяет говорить об эффективности платформы и доверии медицинских специалистов к новому ПО.
	...
	другие устройства путем сканирования открытых портов. При этом он также автоматически обновляется, когда операторы вносят доработки. `, "#", "Григорий", "static/img/photo-elon-musk.jpg",
		"#", 97, 1003,
	},
...
var TestUsers = []amodels.Author{
	{1, "mollenTEST1", "mollenTEST1", "mollenTEST1", "static/img/photo-elon-musk.jpg", "", "mollenTEST1", "mollenTEST@1", 123456},
	{2, "dar", "dar@exp.ru", "dar@exp.ru", "dar@exp.ru", "static/img/photo-elon-musk.jpg", "", "dar@exp.ru", 13553},
	{3, "viphania", "viphania@exp.ru", "viphania@exp.ru", "static/img/photo-elon-musk.jpg", "", "viphania@exp.ru", "123", 120},
